...
def makeWebhookResult(req):
    ...
    if str(zone) =='BMW':
        speech = "Hey"+ str(vid1[vid]) + ", I could offer a deal. Instead of standard "+str(cost[zone])+" on your AMEX blue cash card, I can instantly offer 6 months pro-rated installment payments on your current large purchase of" + dollars + " or above with" +zone+". This offer will expire in next 48 hours."
